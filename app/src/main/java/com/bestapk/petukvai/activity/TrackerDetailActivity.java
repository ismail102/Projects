...
import com.bestapk.petukvai.adapter.ItemsAdapter;
        ...
        if (order.getStatus().equalsIgnoreCase("cancelled")) {
            ...
            for (int i = 0; i < order.getOrderStatusArrayList().size(); i++) {
                ...
                if (img != 0 && findViewById(img) != null) {
                    ...
                    imageView.setColorFilter(getResources().getColor(R.color.app_color_3));
                }

                if (view != 0 && findViewById(view) != null) {
                    View view1 = findViewById(view);
                    view1.setBackgroundColor(getResources().getColor(R.color.app_color_3));
                }
                                ...
                                public void onSuccess(boolean result, String response) {
                                    ...
                                    if (result) {
                                        try {
                                            ...
                                            System.out.println("=======> Place order Response Object: " + obj);

                                            int sIndex = obj.indexOf("{");
                                            int eIndex = obj.indexOf("}");
                                            String subString = obj.substring(sIndex,eIndex+1);

                                            System.out.println("=======> Sub String Object: " + obj);
