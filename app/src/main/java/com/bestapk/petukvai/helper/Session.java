...
public class Session {
    ...
    public static final String KEY_AREA_DELIVERY_CHARGE = "area_delivery_charge";
    ...
    public void createUserLoginSession(String fcmId, String id, String name, String email, String mobile, String dob, String city,
                                       String area, String subArea, String cityId, String areaId, String subAreaId, String address,
                                       String pincode,
                                       String status,String createdat, String apikey, String password, String referCode, String latitude,
                                       String longitude) {
        ...
        editor.putString(KEY_SUB_AREA, subArea);
        editor.putString(KEY_CITY_ID, cityId);
        editor.putString(KEY_AREA_ID, areaId);
        editor.putString(KEY_SUB_AREA_ID, subAreaId);
