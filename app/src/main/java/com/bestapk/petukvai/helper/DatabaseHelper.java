...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "petuk_db";
...
//    public double getAreaDeliveryCharge(Session session) {
//        String AREA = session.getData(Session.KEY_AREA);
//        String dbQuery = "SELECT  * FROM " + TABLE_ORDER_NAME + " WHERE " + "price" + " = ?";
//        String[] args = new String[]{"300"};
//        SQLiteDatabase db = this.getWritableDatabase();
//        Cursor cursor = db.rawQuery(dbQuery, args);
//        double deliveryCharge = 0.0;
//        if(cursor.moveToNext()) {
//            deliveryCharge = cursor.getDouble(cursor.getColumnIndex("area_delivery_charge"));
//        }
//        cursor.close();
