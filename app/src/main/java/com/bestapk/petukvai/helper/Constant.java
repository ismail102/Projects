...
//    public static String ADMIN_USER = "ismail";
//    public static String APP_NAME = "Petuk";
    ...
    public static String GET_SUB_AREA_BY_AREA = BaseUrl + "get-sub-areas-by-area-id.php";
    ...
    public static String SUB_AREA_NAME = "sub_area_name";
    public static String SUB_AREA_ID = "sub_area_id";
    ...
    public static Double SETTING_MINIMUM_AMOUNT_FOR_FREE_DELIVERY = 10000000.0;
    ...
    public static String NAGADPAY = "1";
    public static String BKASHPAY = "1";
    public static String ROCKETPAY = "1";
